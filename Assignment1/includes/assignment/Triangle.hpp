...
public:
    ...
    void setVertex(int ind, const Vector3f &ver);      /*set i-th vertex coordinates*/
    void setNormal(int ind, const Vector3f &n);        /*set i-th vertex normalvector*/
